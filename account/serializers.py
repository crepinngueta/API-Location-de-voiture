...
class VehicleSerializer(serializers.ModelSerializer):
    class Meta:
        model = Vehicle
        fields = ['id', 'vehicle_type', 'make', 'model', 'year', 'vin', 'kilometers', 'color', 'seats',
...
class VehicleUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Vehicle
        fields = ['make', 'vehicle_type', 'model', 'year', 'vin', 'kilometers', 'color', 'seats', 'location_id', 'available_from', 'available_to', 'price_per_day', 'is_available', 'photo_1', 'photo_2', 'photo_3', 'photo_4']
...
from rest_framework import serializers
from .models import Contact, Reservation, Payment
...
class ContactSerializer(serializers.ModelSerializer):
    client_name = serializers.ReadOnlyField(source='get_client_name')

    class Meta:
        model = Contact
        fields = ['id', 'client_name', 'email', 'phone_number', 'message', 'created_at']
        read_only_fields = ['client_contact', 'created_at']
...
class OwnerReservationSerializer(serializers.ModelSerializer):
    class Meta:
        model = Reservation
        fields = ['id', 'client', 'vehicle', 'start_date', 'end_date', 'reservation_date', 'total_cost', 'status'] 
